 ...
 */
public class Educational extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener {
    private RecyclerView mRecyclerView;
    String STRING_TAG="EDUCATIONAL";
    String username;
    ...
    public void listenerFunction(String username){
        ...
        if(checkConnection(getContext())){
            RecyclerRequest recyclerRequest=new RecyclerRequest(username,"educational", responseListener);
