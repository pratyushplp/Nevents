 ...
 */
public class Trending extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener{
    private RecyclerView mRecyclerView;
    String STRING_TAG="TRENDING";
    String username;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.trend_recycler_view);
    ...
    public void trendListener(final String username){
        ...
        if(checkConnection(getContext())){
            RecyclerRequest recyclerRequest=new RecyclerRequest(username,"trending", responseListener);
