 ...
 */
public class Others extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener {
    private RecyclerView mRecyclerView;
    String STRING_TAG="OTHERS";
    String username;
    ...
    public void listenerFunction(String username){
        ...
        if(checkConnection(getContext())){
            RecyclerRequest recyclerRequest=new RecyclerRequest(username,"others", responseListener);
