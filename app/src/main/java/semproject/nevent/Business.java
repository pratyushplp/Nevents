 ...
 */
public class Business extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener {
    private RecyclerView mRecyclerView;
    String STRING_TAG="BUSSINESS";
    String username;
    ...
    public void listenerFunction(String username){
        ...
        if(checkConnection(getContext())){
            RecyclerRequest recyclerRequest=new RecyclerRequest(username,"business", responseListener);
