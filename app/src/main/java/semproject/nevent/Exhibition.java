 ...
 */
public class Exhibition extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener {
    private RecyclerView mRecyclerView;
    String STRING_TAG="EXHIBITION";
    String username;
    ...
    public void listenerFunction(String username){
        ...
        if(checkConnection(getContext())){
            RecyclerRequest recyclerRequest=new RecyclerRequest(username,"exhibition", responseListener);
