 ...
 */
public class Conference extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener {
    private RecyclerView mRecyclerView;
    String STRING_TAG="Conference";
    String username;
    ...
    public void conferenceListener(final String username){
        ...
        if(checkConnection(getContext())){
            RecyclerRequest recyclerRequest=new RecyclerRequest(username,"conference", responseListener);
